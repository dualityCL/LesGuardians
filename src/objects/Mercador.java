...
public class Mercador {
    ...
    private Map<Integer, World.Duo<Integer, Integer>> _path = new HashMap<Integer, World.Duo<Integer, Integer>>();
    private DecimalFormat _porcentaje = new DecimalFormat("0.0");

    public Mercador(int mercadilloID, float tasa, short tiempoVenta, short maxObjCuenta, short nivelMax, String tipoObj) {
    ...
    public String analizarParaEHl(int modeloID) {
        int tipo = World.getObjModelo(modeloID).getTipo();
    ...
    public void addObjMercaAlPuesto(ObjetoMercadillo objMerca) {
        ...
        this._path.put(objMerca.getLineaID(), new World.Duo<Integer, Integer>(tipoObj, idModelo));
        World.addObjMercadillo(objMerca.getDue\u00f1o(), this._idPuestoMerca, objMerca);
    }
    ...
    public boolean borrarObjMercaDelPuesto(ObjetoMercadillo objMerca) {
        ...
        if (borrable) {
            ...
            World.borrarObjMercadillo(objMerca.getDue\u00f1o(), objMerca.getIDDelPuesto(), objMerca);
        }
        return borrable;
    }

    public synchronized boolean comprarObjeto(int lineaID, int cant, int precio, Personagens nuevoDue\u00f1o) {
        boolean posible;
        block8: {
            posible = true;
        ...
        try {
            ...
            if (objAComprar.getDue\u00f1o() != -1 && (cuenta = World.getCuenta(objAComprar.getDue\u00f1o())) != null) {
            ...
            if (World.getCuenta(objAComprar.getDue\u00f1o()) != null && World.getCuenta(objAComprar.getDue\u00f1o()).getTempPersonaje() != null) {
                SocketManager.ENVIAR_Im_INFORMACION(World.getCuenta(objAComprar.getDue\u00f1o()).getTempPersonaje(), "065;" + precio + "~" + objeto.getModelo().getID() + "~" + objeto.getModelo().getID() + "~1");
            }
    ...
    private class Modelo {
        ...
        public void addObjMercaConLinea(ObjetoMercadillo objMerca) {
            ...
            int lineaID = World.sigIDLineaMercadillo();
