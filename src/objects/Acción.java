        ...
        switch (this._ID) {
            ...
            case 27: {
                try {
                    ...
                    MobModelo.GrupoMobs grupo = new MobModelo.GrupoMobs(perso.getMapa()._sigIDMapaInfo, perso.getCelda().getID(), mobGrupo);
            ...
            case 33: {
                ...
                if (!perso.addObjetoSimilar(nuevo = Mundo.getObjModelo(objBoost).crearObjPosDesdeModelo(1, 20, false), true, -1)) {
            ...
            case 36: {
                try {
                    ...
                    if ((tuto = Mundo.getTutorial(tutorial)) == null) {
                        return;
                    }
            ...
            case 201: {
                try {
                    ...
                    Prisma prisma = new Prisma(Mundo.getSigIDPrisma(), (byte)alineacion, (byte)1, (short)mapa.getID(), (short)celdapj, 0, (short)-1);
            ...
            case 228: {
                ...
                SocketManager.ENVIAR_GA_ACCION_JUEGO_AL_MAPA(perso.getMapa(), "0", 228, String.valueOf(perso.getID()) + ";" + celda + "," + Animación.preparaAGameAccion(animacion), "");
                return;
            }
            default: {
