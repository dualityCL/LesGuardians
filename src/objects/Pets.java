...
public class Pets {
    ...
    public Pets(int objetoID, int PDV, String stats, int nrComidas, int a\u00f1o, int mes, int dia, int hora, int minuto, int ultComida, String almasDevoradas, int obeso, int delgado, int idModelo) {
        ...
        this._mascModelo = World.getMascotaModelo(this._idModelo);
    ...
    public boolean esComestible(int idModComida) {
        ...
        ArrayList comidas = this._mascModelo._comidas;
        ...
        if (this._nroComidas == 3) {
            ...
            for (Comida comi : this._mascModelo._comidas) {
                if (comi.getIDComida() < 0) {
                    Objeto.ObjetoModelo objMod = World.getObjModelo(idModComida);
    ...
    public String analizarStatsMascota() {
        ...
        if (!this._almasDevoradas.isEmpty()) {
            ...
            for (String almas : this._almasDevoradas.split(";")) {
                ...
                String nombreMob = World.getMobModelo(idReal).getNombre();
    ...
    public static class MascotaModelo {
        ...
        private ArrayList<World.Duo<Integer, Integer>> _statsPorEfecto = new ArrayList();
        ...
        public MascotaModelo(int maxStas, String statsPorEfecto, String comidas, int devorador) {
            ...
            for (n = 0; n < n2; ++n) {
                ...
                try {
                    this._statsPorEfecto.add(new World.Duo<Integer, Integer>(Integer.parseInt(s.split(";")[0]), Integer.parseInt(s.split(";")[1])));
                    continue;
                }
                catch (Exception exception) {
                    // empty catch block
        ...
        public int getStatsPorEfecto(int stat) {
            for (World.Duo<Integer, Integer> duo : this._statsPorEfecto) {
