...
public class SpellEffect {
    ...
    private Fight.Luchador _lanzador = null;
    ...
    private Maps.Celda _celdaObj = null;
    ...
    public SpellEffect(int aID, String aArgs, int aHechizo, int aNivelHechizo) {
        this._efectoID = aID;
        this._args = aArgs;
    ...
    public SpellEffect(int id, int aValor, int aDuracion, int aTurnos, boolean debuffeable, Fight.Luchador aLanzador, String args2, int aHechizoID, boolean veneno) {
        this._efectoID = id;
        this._valor = aValor;
    ...
    public void aplicarBuffDeInicioTurno(Fight pelea, Fight.Luchador afectado) {
    ...
    public void aplicarHechizoAPelea(Fight pelea, Fight.Luchador lanzador, Maps.Celda casilla, ArrayList<Fight.Luchador> objetivos, ArrayList<Maps.Celda> celdas) {
        this._celdaObj = casilla;
        this.aplicarAPelea(pelea, lanzador, objetivos, false, celdas);
    }

    public Fight.Luchador getLanzador() {
    ...
    public int getMaxMinHechizo(Fight.Luchador objetivo, int valor) {
        int val = valor;
    ...
    public static ArrayList<Fight.Luchador> getAfectados(Fight pelea, ArrayList<Maps.Celda> celdas, int hechizo) {
        ArrayList<Fight.Luchador> objetivos = new ArrayList<Fight.Luchador>();
        if (hechizo == 418) {
            int i = 4;
            ArrayList<Maps.Celda> celdas1 = new ArrayList<Maps.Celda>();
            ArrayList<Maps.Celda> celdas2 = new ArrayList<Maps.Celda>();
            ArrayList<Maps.Celda> celdas3 = new ArrayList<Maps.Celda>();
            ArrayList<Maps.Celda> celdas4 = new ArrayList<Maps.Celda>();
            for (Maps.Celda celda : celdas) {
                if (i % 4 == 0) {
                    celdas1.add(celda);
                } else if (i % 4 == 1) {
                    celdas2.add(celda);
    ...
    public static int aplicarBuffContraGolpe(int da\u00f1oFinal, Fight.Luchador objetivo, Fight.Luchador lanzador, Fight pelea, int hechizoID, boolean esVeneno) {
        int[] arrn = Constantes.BUFF_ACCION_RESPUESTA;
        int n = Constantes.BUFF_ACCION_RESPUESTA.length;
        for (int i = 0; i < n; ++i) {
            int id = arrn[i];
            block23: for (SpellEffect buff : objetivo.getBuffsPorEfectoID(id)) {
                ...
                block6 : switch (id) {
                    case 9: {
                        ...
                        Maps.Celda aCelda = lanzador.getCeldaPelea();
                        Fight.Luchador afectado = null;
                        Maps mapaCopia = pelea.getMapaCopia();
                        ...
                        if (nuevaCeldaID < 0) {
                            ...
                            Maps.Celda celdaSig = mapaCopia.getCelda(celdaSigID);
                            if (celdaSig != null) {
    ...
    public void aplicarAPelea(Fight pelea, Fight.Luchador aLanzador, ArrayList<Fight.Luchador> objetivos, boolean esCaC, ArrayList<Maps.Celda> celdas) {
        Personagens perso;
        try {
            if (this._turnos != -1) {
        ...
        if (pelea.getTipoPelea() == 4 && this._lanzador.getPersonaje() != null && SpellEffect.esEfectoReto(this._efectoID)) {
            ...
            for (Map.Entry entry : copiaRetos.entrySet()) {
                ...
                block2 : switch (reto) {
                    case 21: {
                        ...
                        for (Fight.Luchador luch : pelea._inicioLucEquipo2) {
                    ...
                    case 31: {
                        ...
                        for (Fight.Luchador luch : objetivos) {
    ...
    private void aplicarEfecto_4(Fight pelea) {
        if (this._turnos > 1) {
            return;
        }
        if (this._celdaObj.esCaminable(true) && !pelea.celdaOcupada(this._celdaObj.getID())) {
            ...
            ArrayList<Fight.Trampa> trampas = new ArrayList<Fight.Trampa>();
            trampas.addAll(pelea.getTrampas());
            for (Fight.Trampa trampa : trampas) {
    ...
    private void aplicarEfecto_5(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        ...
        if (this._turnos <= 0) {
            for (Fight.Luchador objetivo : objetivos) {
                ...
                Maps.Celda celdaLanz = this._celdaObj;
                int da\u00f1oFinal = 0;
                Fight.Luchador afectado = null;
    ...
    private void aplicarEfecto_6(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        if (this._turnos <= 0) {
            block4: for (Fight.Luchador objetivo : objetivos) {
                short nuevaCeldaID;
                if (objetivo.estaMuerto() || objetivo.tieneEstado(6)) continue;
                Maps.Celda eCelda = this._celdaObj;
                if (objetivo.getCeldaPelea().getID() == this._celdaObj.getID()) {
    ...
    private void aplicarEfecto_8(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        if (objetivos.isEmpty()) {
            return;
        }
        Fight.Luchador objetivo = objetivos.get(0);
        ...
        Maps.Celda exCeldaObjetivo = objetivo.getCeldaPelea();
        Maps.Celda exCeldaLanzador = this._lanzador.getCeldaPelea();
    ...
    private void aplicarEfecto_9(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        for (Fight.Luchador objetivo : objetivos) {
    ...
    private void aplicarEfecto_50(Fight pelea) {
        Fight.Luchador objetivo = this._celdaObj.getPrimerLuchador();
        if (objetivo == null) {
            return;
        }
        if (objetivo.estaMuerto()) {
    ...
    private void aplicarEfecto_51(Fight pelea) {
        if (!this._celdaObj.esCaminable(true) || this._celdaObj.getLuchadores().size() > 0) {
            return;
        }
        Fight.Luchador objetivo = this._lanzador.getTransportando();
        if (objetivo == null || objetivo.estaMuerto()) {
            return;
        }
        Maps.Celda celdaLanz = this._lanzador.getCeldaPelea();
    ...
    private void aplicarEfecto_77(ArrayList<Fight.Luchador> afectados, Fight pelea) {
        int valor = -1;
        try {
            valor = Integer.parseInt(this._args.split(";")[0]);
        }
        ...
        int num = 0;
        for (Fight.Luchador objetivo : afectados) {
            if (objetivo.estaMuerto()) continue;
    ...
    private void aplicarEfecto_78(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val;
    ...
    private void aplicarEfecto_79(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        if (this._turnos < 1) {
            return;
        }
        for (Fight.Luchador objetivo : objetivos) {
    ...
    private void aplicarEfecto_82(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        if (this._turnos <= 0) {
            for (Fight.Luchador objetivo : objetivos) {
                if (objetivo.estaMuerto()) continue;
                ...
                if ((da\u00f1oFinal = SpellEffect.aplicarBuffContraGolpe(da\u00f1oFinal, objetivo, this._lanzador, pelea, this._hechizoID, this._veneno)) > objetivo.getPDVConBuff()) {
                    da\u00f1oFinal = objetivo.getPDVConBuff();
                }
                objetivo.restarPDV(da\u00f1oFinal);
                da\u00f1oFinal = -da\u00f1oFinal;
    ...
    private void aplicarEfecto_84(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int valor = -1;
        try {
            valor = Integer.parseInt(this._args.split(";")[0]);
        }
    ...
    private void aplicarEfecto_85(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        if (this._turnos <= 0) {
            for (Fight.Luchador objetivo : objetivos) {
                if (objetivo.estaMuerto()) continue;
                if (objetivo.tieneBuff(106) && objetivo.getValorBuffPelea(106) >= this._nivelHechizo && this._hechizoID != 0) {
                ...
                da\u00f1oFinal = SpellEffect.aplicarBuffContraGolpe(da\u00f1oFinal, objetivo, this._lanzador, pelea, this._hechizoID, this._veneno);
    ...
    private void aplicarEfecto_86(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        if (this._turnos <= 0) {
            for (Fight.Luchador objetivo : objetivos) {
                if (objetivo.estaMuerto()) continue;
                if (objetivo.tieneBuff(106) && objetivo.getValorBuffPelea(106) >= this._nivelHechizo && this._hechizoID != 0) {
    ...
    private void aplicarEfecto_87(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        if (this._turnos <= 0) {
            for (Fight.Luchador objetivo : objetivos) {
                if (objetivo.estaMuerto()) continue;
                if (objetivo.tieneBuff(106) && objetivo.getValorBuffPelea(106) >= this._nivelHechizo && this._hechizoID != 0) {
    ...
    private void aplicarEfecto_88(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        if (this._turnos <= 0) {
            for (Fight.Luchador objetivo : objetivos) {
                if (objetivo.estaMuerto()) continue;
                if (objetivo.tieneBuff(106) && objetivo.getValorBuffPelea(106) >= this._nivelHechizo && this._hechizoID != 0) {
    ...
    private void aplicarEfecto_89(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        if (this._hechizoID == 1679) {
            char[] dir = new char[]{'b', 'd', 'f', 'h'};
            Fight.Luchador victima = objetivos.get(0);
            objetivos.clear();
            for (int i = 0; i < 4; ++i) {
                Fight.Luchador objetivo;
                short idSigCelda = Pathfinding.getSigIDCeldaMismaDir(victima.getCeldaPelea().getID(), dir[i], pelea.getMapaCopia(), true);
                Maps.Celda sigCelda = pelea.getMapaCopia().getCelda(idSigCelda);
    ...
    private void aplicarEfecto_81(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        if (this._turnos <= 0) {
    ...
    private void aplicarEfecto_90(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        if (this._turnos <= 0) {
    ...
    private void aplicarEfecto_91(ArrayList<Fight.Luchador> objetivos, Fight pelea, boolean esCaC) {
        if (esCaC) {
    ...
    private void aplicarEfecto_92(ArrayList<Fight.Luchador> objetivos, Fight pelea, boolean esCaC) {
        if (esCaC) {
            if (this._lanzador.esInvisible()) {
                this._lanzador.hacerseVisible(-1);
            }
    ...
    private void aplicarEfecto_93(ArrayList<Fight.Luchador> objetivos, Fight pelea, boolean esCaC) {
        if (esCaC) {
            if (this._lanzador.esInvisible()) {
                this._lanzador.hacerseVisible(-1);
            }
    ...
    private void aplicarEfecto_94(ArrayList<Fight.Luchador> objetivos, Fight pelea, boolean esCaC) {
        if (esCaC) {
            if (this._lanzador.esInvisible()) {
                this._lanzador.hacerseVisible(-1);
            }
    ...
    private void aplicarEfecto_95(ArrayList<Fight.Luchador> objetivos, Fight pelea, boolean esCaC) {
        if (esCaC) {
            if (this._lanzador.esInvisible()) {
                this._lanzador.hacerseVisible(-1);
            }
    ...
    private void aplicarEfecto_96(ArrayList<Fight.Luchador> objetivos, Fight pelea, boolean esCaC) {
        if (esCaC) {
            if (this._lanzador.esInvisible()) {
                this._lanzador.hacerseVisible(-1);
            }
            for (Fight.Luchador objetivo : objetivos) {
                ...
                int da\u00f1o = Fórmulas.getRandomValor(this._valores);
                da\u00f1o = this.getMaxMinHechizo(objetivo, da\u00f1o);
                for (SpellEffect EH : this._lanzador.getBuffsPorEfectoID(293)) {
    ...
    private void aplicarEfecto_97(ArrayList<Fight.Luchador> objetivos, Fight pelea, boolean esCaC) {
        if (esCaC) {
            if (this._lanzador.esInvisible()) {
                this._lanzador.hacerseVisible(-1);
            }
            ...
            for (Fight.Luchador objetivo : objetivos) {
                ...
                if (this._suerte > 0 && this._hechizoID == 108) {
                    ...
                    if ((da\u00f1oFinal = SpellEffect.aplicarBuffContraGolpe(da\u00f1oFinal, this._lanzador, this._lanzador, pelea, this._hechizoID, this._veneno)) > this._lanzador.getPDVConBuff()) {
                        da\u00f1oFinal = this._lanzador.getPDVConBuff();
                    }
                    this._lanzador.restarPDV(da\u00f1oFinal);
                    da\u00f1oFinal = -da\u00f1oFinal;
    ...
    private void aplicarEfecto_98(ArrayList<Fight.Luchador> objetivos, Fight pelea, boolean esCaC) {
        if (esCaC) {
            if (this._lanzador.esInvisible()) {
                this._lanzador.hacerseVisible(-1);
            }
    ...
    private void aplicarEfecto_99(ArrayList<Fight.Luchador> objetivos, Fight pelea, boolean esCaC) {
        if (esCaC) {
            if (this._lanzador.esInvisible()) {
                this._lanzador.hacerseVisible(-1);
            }
    ...
    private void aplicarEfecto_100(ArrayList<Fight.Luchador> objetivos, Fight pelea, boolean esCaC) {
        if (esCaC) {
            if (this._lanzador.esInvisible()) {
                this._lanzador.hacerseVisible(-1);
            }
    ...
    private void aplicarEfecto_101(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        if (this._turnos <= 0) {
            for (Fight.Luchador objetivo : objetivos) {
                if (objetivo.estaMuerto()) continue;
    ...
    private void aplicarEfecto_105(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val;
        int val2 = val = Fórmulas.getRandomValor(this._valores);
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
    ...
    private void aplicarEfecto_106(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val = -1;
        try {
    ...
    private void aplicarEfecto_107(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        if (this._turnos < 1) {
            return;
        }
        for (Fight.Luchador objetivo : objetivos) {
    ...
    private void aplicarEfecto_108(ArrayList<Fight.Luchador> objetivos, Fight pelea, boolean esCaC) {
        if (esCaC) {
            if (this._lanzador.esInvisible()) {
                this._lanzador.hacerseVisible(-1);
            }
    ...
    private void aplicarEfecto_109(Fight pelea) {
        if (this._turnos <= 0) {
            int da\u00f1o = Fórmulas.getRandomValor(this._valores);
    ...
    private void aplicarEfecto_110(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val;
        int val2 = val = Fórmulas.getRandomValor(this._valores);
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
    ...
    private void aplicarEfecto_111(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val;
        int val2 = val = Fórmulas.getRandomValor(this._valores);
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
    ...
    private void aplicarEfecto_112(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val;
        int val2 = val = Fórmulas.getRandomValor(this._valores);
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
    ...
    private void aplicarEfecto_114(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val;
        int val2 = val = Fórmulas.getRandomValor(this._valores);
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
    ...
    private void aplicarEfecto_115(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val;
        int val2 = val = Fórmulas.getRandomValor(this._valores);
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
    ...
    private void aplicarEfecto_116(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val;
        int val2 = val = Fórmulas.getRandomValor(this._valores);
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
    ...
    private void aplicarEfecto_117(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val;
        int val2 = val = Fórmulas.getRandomValor(this._valores);
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
    ...
    private void aplicarEfecto_118(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val;
        int val2 = val = Fórmulas.getRandomValor(this._valores);
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
    ...
    private void aplicarEfecto_119(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val;
        int val2 = val = Fórmulas.getRandomValor(this._valores);
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
    ...
    private void aplicarEfecto_120(Fight pelea) {
    ...
    private void aplicarEfecto_121(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val;
        int val2 = val = Fórmulas.getRandomValor(this._valores);
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
    ...
    private void aplicarEfecto_122(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val;
        int val2 = val = Fórmulas.getRandomValor(this._valores);
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
    ...
    private void aplicarEfecto_123(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val;
        int val2 = val = Fórmulas.getRandomValor(this._valores);
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
    ...
    private void aplicarEfecto_124(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val;
        int val2 = val = Fórmulas.getRandomValor(this._valores);
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
    ...
    private void aplicarEfecto_125(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val;
    ...
    private void aplicarEfecto_126(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val;
        int val2 = val = Fórmulas.getRandomValor(this._valores);
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
    ...
    private void aplicarEfecto_127(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        if (this._turnos <= 0) {
            for (Fight.Luchador objetivo : objetivos) {
                if (objetivo.estaMuerto()) continue;
    ...
    private void aplicarEfecto_128(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val;
        int val2 = val = Fórmulas.getRandomValor(this._valores);
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
    ...
    private void aplicarEfecto_130(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        if (pelea.getTipoPelea() == 0) {
            return;
        }
        int val = Fórmulas.getRandomValor(this._valores);
        for (Fight.Luchador objetivo : objetivos) {
            Personagens perso = objetivo.getPersonaje();
            ...
            Personagens perso2 = this._lanzador.getPersonaje();
            if (perso2 != null) {
    ...
    private void aplicarEfecto_131(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
            objetivo.addBuff(this._efectoID, this._valor, this._turnos, 1, true, this._hechizoID, this._args, this._lanzador, this._veneno);
        }
    ...
    private void aplicarEfecto_132(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
            objetivo.desbuffear();
            if (objetivo.puedeJugar() && objetivo == this._lanzador) {
                Personagens.Stats s1 = objetivo.getTotalStatsConBuff();
                Personagens.Stats s2 = objetivo.getTotalStatsSinBuff();
    ...
    private void aplicarEfecto_138(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val;
        int val2 = val = Fórmulas.getRandomValor(this._valores);
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
    ...
    private void aplicarEfecto_140(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
            objetivo.addBuff(this._efectoID, 0, this._turnos, 0, true, this._hechizoID, this._args, this._lanzador, this._veneno);
        }
    ...
    private void aplicarEfecto_141(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
            if (objetivo.tieneBuff(765) && objetivo.getBuff(765) != null && !objetivo.getBuff(765).getLanzador().estaMuerto()) {
                this.aplicarEfecto_765B(pelea, objetivo);
    ...
    private void aplicarEfecto_143(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        if (this._turnos <= 0) {
            String[] jet = this._args.split(";");
            int cura = 0;
            cura = jet.length < 6 ? 1 : Fórmulas.getRandomValor(jet[5]);
    ...
    private void aplicarEfecto_142(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val;
        int val2 = val = Fórmulas.getRandomValor(this._valores);
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
    ...
    private void aplicarEfecto_144(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val;
        int val2 = val = Fórmulas.getRandomValor(this._valores);
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
    ...
    private void aplicarEfecto_145(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val;
        int val2 = val = Fórmulas.getRandomValor(this._valores);
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
    ...
    private void aplicarEfecto_149(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int id = -1;
        try {
    ...
    private void aplicarEfecto_150(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        if (this._turnos == 0) {
            return;
        }
        for (Fight.Luchador objetivo : objetivos) {
    ...
    private void aplicarEfecto_152(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val;
        int val2 = val = Fórmulas.getRandomValor(this._valores);
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
    ...
    private void aplicarEfecto_153(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val;
        int val2 = val = Fórmulas.getRandomValor(this._valores);
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
    ...
    private void aplicarEfecto_154(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val;
        int val2 = val = Fórmulas.getRandomValor(this._valores);
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
    ...
    private void aplicarEfecto_155(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val;
        int val2 = val = Fórmulas.getRandomValor(this._valores);
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
    ...
    private void aplicarEfecto_156(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val;
        int val2 = val = Fórmulas.getRandomValor(this._valores);
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
    ...
    private void aplicarEfecto_157(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val;
        int val2 = val = Fórmulas.getRandomValor(this._valores);
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
    ...
    private void aplicarEfecto_160(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val;
        int val2 = val = Fórmulas.getRandomValor(this._valores);
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
    ...
    private void aplicarEfecto_161(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val;
        int val2 = val = Fórmulas.getRandomValor(this._valores);
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
    ...
    private void aplicarEfecto_162(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val;
        int val2 = val = Fórmulas.getRandomValor(this._valores);
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
    ...
    private void aplicarEfecto_163(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val;
        int val2 = val = Fórmulas.getRandomValor(this._valores);
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
    ...
    private void aplicarEfecto_164(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val = this._valor;
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
            objetivo.addBuff(this._efectoID, val, this._turnos, 1, false, this._hechizoID, this._args, this._lanzador, this._veneno);
    ...
    private void aplicarEfecto_165(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int valor = -1;
        try {
    ...
    private void aplicarEfecto_168(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        if (this._turnos <= 0) {
            for (Fight.Luchador objetivo : objetivos) {
                if (objetivo.estaMuerto()) continue;
    ...
    private void aplicarEfecto_169(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        if (this._turnos <= 0) {
            for (Fight.Luchador objetivo : objetivos) {
                if (objetivo.estaMuerto()) continue;
                objetivo.addBuff(this._efectoID, this._valor, 1, 1, true, this._hechizoID, this._args, this._lanzador, this._veneno);
    ...
    private void aplicarEfecto_171(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val;
        int val2 = val = Fórmulas.getRandomValor(this._valores);
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
    ...
    private void aplicarEfecto_176(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val = Fórmulas.getRandomValor(this._valores);
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
            objetivo.addBuff(this._efectoID, val, this._turnos, 1, true, this._hechizoID, this._args, this._lanzador, this._veneno);
    ...
    private void aplicarEfecto_177(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val = Fórmulas.getRandomValor(this._valores);
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
            objetivo.addBuff(this._efectoID, val, this._turnos, 1, true, this._hechizoID, this._args, this._lanzador, this._veneno);
    ...
    private void aplicarEfecto_178(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val;
        int val2 = val = Fórmulas.getRandomValor(this._valores);
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
    ...
    private void aplicarEfecto_179(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val;
        int val2 = val = Fórmulas.getRandomValor(this._valores);
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
    ...
    private void aplicarEfecto_180(Fight pelea) {
        ...
        Personagens clon = Personagens.personajeClonado(this._lanzador.getPersonaje(), idInvocacion);
        Fight.Luchador doble = new Fight.Luchador(pelea, clon);
    ...
    private void aplicarEfecto_181(Fight pelea) {
        if (this._celdaObj.getPrimerLuchador() != null) {
            SocketManager.ENVIAR_GA_ACCION_PELEA(pelea, 7, 151, String.valueOf(this._lanzador.getID()), String.valueOf(this._hechizoID));
            return;
        }
        ...
        MOB_tmpl.MobGrado mob = null;
        try {
            mob = World.getMobModelo(mobID).getGradoPorNivel(mobNivel).copiarMob();
        }
        catch (Exception e1) {
        ...
        Fight.Luchador invocacion = new Fight.Luchador(pelea, mob);
    ...
    private void aplicarEfecto_182(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val;
        int val2 = val = Fórmulas.getRandomValor(this._valores);
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
    ...
    private void aplicarEfecto_183(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val;
        int val2 = val = Fórmulas.getRandomValor(this._valores);
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
    ...
    private void aplicarEfecto_184(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val;
        int val2 = val = Fórmulas.getRandomValor(this._valores);
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
    ...
    private void aplicarEfecto_185(Fight pelea) {
        ...
        MOB_tmpl.MobGrado MG = null;
        try {
            MG = World.getMobModelo(mobID).getGradoPorNivel(nivel).copiarMob();
        }
        catch (Exception e1) {
            System.out.println("El Mob ID esta mal configurado: " + mobID);
            return;
        ...
        Fight.Luchador invocacion = new Fight.Luchador(pelea, MG);
        int equipoLanz = this._lanzador.getEquipoBin();
        invocacion.setEquipoBin(equipoLanz);
        invocacion.setInvocador(this._lanzador);
        Maps.Celda nuevaCelda = pelea.getMapaCopia().getCelda(celdaID);
    ...
    private void aplicarEfecto_186(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val;
        int val2 = val = Fórmulas.getRandomValor(this._valores);
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
    ...
    private void aplicarEfecto_202(ArrayList<Fight.Luchador> objetivos, Fight pelea, ArrayList<Maps.Celda> celdas) {
    ...
    private void aplicarEfecto_210(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val;
        int val2 = val = Fórmulas.getRandomValor(this._valores);
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
    ...
    private void aplicarEfecto_211(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val;
        int val2 = val = Fórmulas.getRandomValor(this._valores);
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
    ...
    private void aplicarEfecto_212(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val;
        int val2 = val = Fórmulas.getRandomValor(this._valores);
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
    ...
    private void aplicarEfecto_213(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val;
        int val2 = val = Fórmulas.getRandomValor(this._valores);
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
    ...
    private void aplicarEfecto_214(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val;
        int val2 = val = Fórmulas.getRandomValor(this._valores);
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
    ...
    private void aplicarEfecto_215(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val;
        int val2 = val = Fórmulas.getRandomValor(this._valores);
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
    ...
    private void aplicarEfecto_216(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val;
        int val2 = val = Fórmulas.getRandomValor(this._valores);
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
    ...
    private void aplicarEfecto_217(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val;
        int val2 = val = Fórmulas.getRandomValor(this._valores);
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
    ...
    private void aplicarEfecto_218(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val;
        int val2 = val = Fórmulas.getRandomValor(this._valores);
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
    ...
    private void aplicarEfecto_219(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val;
        int val2 = val = Fórmulas.getRandomValor(this._valores);
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
    ...
    private void aplicarEfecto_220(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        if (this._turnos < 1) {
            return;
        }
        for (Fight.Luchador objetivo : objetivos) {
    ...
    private void aplicarEfecto_265(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val;
        int val2 = val = Fórmulas.getRandomValor(this._valores);
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
    ...
    private void aplicarEfecto_266(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val = Fórmulas.getRandomValor(this._valores);
        int vol = 0;
        int val2 = val;
        for (Fight.Luchador objetivo : objetivos) {
    ...
    private void aplicarEfecto_267(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val = Fórmulas.getRandomValor(this._valores);
        int vol = 0;
        int val2 = val;
        for (Fight.Luchador objetivo : objetivos) {
    ...
    private void aplicarEfecto_268(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val = Fórmulas.getRandomValor(this._valores);
        int vol = 0;
        int val2 = val;
        for (Fight.Luchador objetivo : objetivos) {
    ...
    private void aplicarEfecto_269(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val = Fórmulas.getRandomValor(this._valores);
        int vol = 0;
        int val2 = val;
        for (Fight.Luchador objetivo : objetivos) {
    ...
    private void aplicarEfecto_270(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val = Fórmulas.getRandomValor(this._valores);
        int vol = 0;
        int val2 = val;
        for (Fight.Luchador objetivo : objetivos) {
    ...
    private void aplicarEfecto_271(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val = Fórmulas.getRandomValor(this._valores);
        int vol = 0;
        int val2 = val;
        for (Fight.Luchador objetivo : objetivos) {
    ...
    private void aplicarEfecto_275(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        if (this._turnos <= 0) {
            for (Fight.Luchador objetivo : objetivos) {
                if (objetivo.estaMuerto()) continue;
                if (objetivo.tieneBuff(106) && objetivo.getValorBuffPelea(106) >= this._nivelHechizo && this._hechizoID != 0) {
    ...
    private void aplicarEfecto_276(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        if (this._turnos <= 0) {
            for (Fight.Luchador objetivo : objetivos) {
                if (objetivo.estaMuerto()) continue;
                if (objetivo.tieneBuff(106) && objetivo.getValorBuffPelea(106) >= this._nivelHechizo && this._hechizoID != 0) {
    ...
    private void aplicarEfecto_277(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        if (this._turnos <= 0) {
            for (Fight.Luchador objetivo : objetivos) {
                if (objetivo.estaMuerto()) continue;
                if (objetivo.tieneBuff(106) && objetivo.getValorBuffPelea(106) >= this._nivelHechizo && this._hechizoID != 0) {
    ...
    private void aplicarEfecto_278(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        if (this._turnos <= 0) {
            for (Fight.Luchador objetivo : objetivos) {
                if (objetivo.estaMuerto()) continue;
                if (objetivo.tieneBuff(106) && objetivo.getValorBuffPelea(106) >= this._nivelHechizo && this._hechizoID != 0) {
    ...
    private void aplicarEfecto_279(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        if (this._turnos <= 0) {
            for (Fight.Luchador objetivo : objetivos) {
                if (objetivo.estaMuerto()) continue;
                if (objetivo.tieneBuff(106) && objetivo.getValorBuffPelea(106) >= this._nivelHechizo && this._hechizoID != 0) {
    ...
    private void aplicarEfecto_293(Fight pelea) {
    ...
    private void aplicarEfecto_320(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int valor = 1;
        try {
            valor = Integer.parseInt(this._args.split(";")[0]);
        }
    ...
    private void aplicarEfecto_400(Fight pelea) {
        ...
        String po = World.getHechizo(this._hechizoID).getStatsPorNivel(this._nivelHechizo).getAfectados();
        byte tama\u00f1o = (byte)CryptManager.getNumeroPorValorHash(po.charAt(1));
        Spell.StatsHechizos ST = World.getHechizo(hechizoTrampaID).getStatsPorNivel(nivel);
        Fight.Trampa trampa = new Fight.Trampa(pelea, this._lanzador, this._celdaObj, tama\u00f1o, ST, this._hechizoID);
    ...
    private void aplicarEfecto_401(Fight pelea) {
        if (!this._celdaObj.esCaminable(true)) {
            return;
        }
        if (this._celdaObj.getPrimerLuchador() != null) {
        ...
        String po = World.getHechizo(this._hechizoID).getStatsPorNivel(this._nivelHechizo).getAfectados();
        byte tama\u00f1o = (byte)CryptManager.getNumeroPorValorHash(po.charAt(1));
        Spell.StatsHechizos ST = World.getHechizo(hechizoGlifoID).getStatsPorNivel(nivel);
        Fight.Glifo glifo = new Fight.Glifo(pelea, this._lanzador, this._celdaObj, tama\u00f1o, ST, duracion, this._hechizoID);
    ...
    private void aplicarEfecto_402(Fight pelea) {
        if (!this._celdaObj.esCaminable(true)) {
            return;
        }
        String[] infos = this._args.split(";");
    ...
    private void aplicarEfecto_606(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val;
        int val2 = val = Fórmulas.getRandomValor(this._valores);
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
    ...
    private void aplicarEfecto_607(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val;
        int val2 = val = Fórmulas.getRandomValor(this._valores);
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
    ...
    private void aplicarEfecto_608(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val;
        int val2 = val = Fórmulas.getRandomValor(this._valores);
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
    ...
    private void aplicarEfecto_609(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val;
        int val2 = val = Fórmulas.getRandomValor(this._valores);
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
    ...
    private void aplicarEfecto_610(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val;
        int val2 = val = Fórmulas.getRandomValor(this._valores);
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
    ...
    private void aplicarEfecto_611(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val;
        int val2 = val = Fórmulas.getRandomValor(this._valores);
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
    ...
    private void aplicarEfecto_671(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        ...
        for (Fight.Luchador objetivo : objetivos) {
            ...
            if ((da\u00f1oFinal = SpellEffect.aplicarBuffContraGolpe(da\u00f1o, objetivo, this._lanzador, pelea, this._hechizoID, this._veneno)) > objetivo.getPDVConBuff()) {
                da\u00f1oFinal = objetivo.getPDVConBuff();
            }
            objetivo.restarPDV(da\u00f1oFinal);
            da\u00f1oFinal = -da\u00f1oFinal;
    ...
    private void aplicarEfecto_672(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        float val = (float)Fórmulas.getRandomValor(this._valores) / 100.0f;
        int pdvMax = this._lanzador.getPDVMaxConBuff();
        int pdvMedio = pdvMax / 2;
        float porc = 1.0f - (float)Math.abs(this._lanzador.getPDVConBuff() - pdvMedio) / (float)pdvMedio;
    ...
    private void aplicarEfecto_750(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
    }

    private void aplicarEfecto_765(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
    ...
    private void aplicarEfecto_765B(Fight pelea, Fight.Luchador objetivo) {
        Fight.Luchador sacrificado = objetivo.getBuff(765).getLanzador();
        Maps.Celda cSacrificado = sacrificado.getCeldaPelea();
        Maps.Celda cObjetivo = objetivo.getCeldaPelea();
    ...
    private void aplicarEfecto_776(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int val = Fórmulas.getRandomValor(this._valores);
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
            objetivo.addBuff(this._efectoID, val, this._turnos, 1, true, this._hechizoID, this._args, this._lanzador, this._veneno);
    ...
    private void aplicarEfecto_780(Fight pelea) {
        Map<Integer, Fight.Luchador> muertos = pelea.getListaMuertos();
        Fight.Luchador objetivo = null;
        for (Map.Entry<Integer, Fight.Luchador> entry : muertos.entrySet()) {
            Fight.Luchador muerto = entry.getValue();
    ...
    private void aplicarEfecto_781(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
            objetivo.addBuff(this._efectoID, this._valor, this._turnos, 1, true, this._hechizoID, this._args, this._lanzador, this._veneno);
        }
    ...
    private void aplicarEfecto_782(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
            objetivo.addBuff(this._efectoID, this._valor, this._turnos, 1, true, this._hechizoID, this._args, this._lanzador, this._veneno);
        }
    ...
    private void aplicarEfecto_783(Fight pelea) {
        Maps.Celda c1celda;
        Fight.Luchador objetivo;
        block13: {
            Maps.Celda celdaLanzador = this._lanzador.getCeldaPelea();
            ...
            Maps.Celda case2 = null;
            ArrayList<Maps.Celda> trampas = new ArrayList<Maps.Celda>();
            for (Fight.Trampa trampa : pelea.getTrampas()) {
    ...
    private void aplicarEfecto_784(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        if (this._turnos > 1) {
            return;
        }
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto() || objetivo.esInvocacion()) continue;
            Maps.Celda celda1 = null;
            for (Map.Entry<Integer, Maps.Celda> entry : pelea.getPosInicial().entrySet()) {
    ...
    private void aplicarEfecto_786(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
            objetivo.addBuff(this._efectoID, this._valor, this._turnos, 1, true, this._hechizoID, this._args, this._lanzador, this._veneno);
        }
    ...
    private void aplicarEfecto_787(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int hechizoID = -1;
        int hechizoNivel = -1;
        try {
        ...
        Spell hechizo = World.getHechizo(hechizoID);
        ArrayList<SpellEffect> EH = hechizo.getStatsPorNivel(hechizoNivel).getEfectos();
    ...
    private void aplicarEfecto_788(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        for (Fight.Luchador objetivo : objetivos) {
            if (objetivo.estaMuerto()) continue;
    ...
    private void aplicarEfecto_950(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int idEstado = -1;
        try {
    ...
    private void aplicarEfecto_951(ArrayList<Fight.Luchador> objetivos, Fight pelea) {
        int id = -1;
        try {
            id = Integer.parseInt(this._args.split(";")[2]);
        }
