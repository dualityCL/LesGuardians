...
public class Objevivo {
    ...
    public Objevivo(int ID, int comidaA\u00f1o, int comidaFecha, int comidaHora, int humor, int mascara, int tipo, int objAsociadoID, long XP, int interAno, int interFecha, int interHoras, int adqA\u00f1o, int adqFecha, int adqHora, int asociado, int realModeloDB, int objevivoOrig, String stats) {
        this._id = ID;
